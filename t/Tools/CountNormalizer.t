...
delta_ok $average->get_richness, 4;
delta_ok $average->total_count, 7;

ok $representative = $normalizer->_calc_representative($average);

delta_ok $representative->total_count, 7;
delta_ok $representative->get_richness, 4;
...
### try a community where richness is decreased when going from average to representative
