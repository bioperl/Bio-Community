...
ok $dist = Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => '2-norm' );
isa_ok $dist, 'Bio::Community::Tools::Distance';

delta_ok $dist->get_distance, 0, 'Identical communities';
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => 'euclidean' )->get_distance, 0;
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => '1-norm' )->get_distance, 0;
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => 'infinity-norm' )->get_distance, 0;
...
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => '2-norm' )->get_distance, 45.2910813657838, 'Communities with all members shared';
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => '1-norm' )->get_distance, 71.7948717948718;
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => 'infinity-norm' )->get_distance, 35.8974358974359;
...
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => '2-norm' )->get_distance, 81.6496580927726, 'Communities with some shared members';
delta_ok Bio::Community::Tools::Distance->new( -communities => [$community1, $community2], -type => '1-norm' )->get_distance, 138.461538461538;
