...
Bio::Community::IO::gaas - Driver to read and write files in the GAAS format
...
This Bio::Community::IO driver reads and writes files in the format generated by
GAAS (http://sourceforge.net/projects/gaas/). Here is an example:
...
for the community members but relative abundances only. Thus, the get_member_count() 
